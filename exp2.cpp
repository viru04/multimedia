...
int main()
{
    ...
    ofstream out1("exp2_output_MinMax.csv",ios::app);
    ofstream out2("exp2_output_Zscore.csv",ios::app);
    ...
    case 2:
        ...
        standard_deviation = sqrt(square_sum / cnt); // to find standard deviation
